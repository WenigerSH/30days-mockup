...
- (void)viewDidLoad {
	...
	UIImageView *loginView = [[UIImageView alloc]initWithFrame:CGRectMake(0, 0, 320, 550)];
	...
	UIButton *nextFormButton = [[UIButton alloc]initWithFrame:CGRectMake(172, 355, 80, 41)];
